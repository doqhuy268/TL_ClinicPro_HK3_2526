# ClinicPro: Hệ thống Quản lý Khám bệnh Thông minh
...
- **NestJS** xây dựng hệ thống backend trung tâm của ClinicPro, quản lý toàn bộ logic nghiệp vụ như lịch khám, hồ sơ bệnh nhân, ưu tiên theo quy định pháp luật và thanh toán chuyển khoản.
...
- **PostgreSQL** được sử dụng làm cơ sở dữ liệu chính để quản lý toàn bộ hệ thống nghiệp vụ lớn của ClinicPro.
